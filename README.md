...
El aplicativo está desarrollado en Python con el framework Flask, conectado a una base de datos en MySQL y con una GUI.

*FUNCIONAMIENTO* <br>
Al ingresar en el aplicativo web se muestra un *home* básico con un menú superior que contiene botones para el login y registro.
